...
export const STAGE_ATMOSPHERE_PRESET_DEFINITIONS: StageAtmospherePresetDefinition[] = [
  {
    ...
    label: 'Luminous Vortex V8 Candidate',
    description: 'A continuous galactic funnel with broad rotating light bands and a bright distant throat.',
    tokens: {
      ...
      backgroundEffectTint: '#91dcff',
      backgroundEffectSecondaryTint: '#b36be8',
